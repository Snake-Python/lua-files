...
do -- DETECTION MANAGER
  ...
  function DETECTION_MANAGER:New( Core.Set#SET_GROUP SetGroup )
    ...
    self:SetRefreshTimeInterval( 60 )
  ...
  -- @return #DETECTION_MANAGER self
  function DETECTION_MANAGER:SetRefreshTimeInterval( 60 )
    self:F2()
  ...
  -- @return #DETECTION_MANAGER self
  function DETECTION_MANAGER:SetReportDisplayTime( 15 )
    self:F2()
  ...
  function DETECTION_MANAGER:GetReportDisplayTime(15)
    self:F2()
